...
def manage_validate_inline_link_objs( self):
  ...
  prt.append('<legend>Validate Inline-Link-Objects</legend>')
  ...
  prt.append('''
    ...
    function ajaxCount(cb) {
        ...
        $.get('manage_validate_inline_link_objs',params,function(data) {
            $('#uid').val(root_node);
            var html = '';
