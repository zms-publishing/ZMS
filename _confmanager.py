...
class ConfManager(
    ...
    def getConfFiles(self, remote=True, pattern=None, REQUEST=None, RESPONSE=None):
      ...
      print("confdict: filepaths=",filepaths)
      filepaths = [os.path.join(os.path.dirname(__file__), 'zms', 'import', 'configure.zcml')]
      print("confdict: filepaths=",filepaths)
    ...
    def customize_manage_options(self):
      l = []
      l.append({'label':self.zmi_icon(name='icon-home'),'action':'manage_main'})
