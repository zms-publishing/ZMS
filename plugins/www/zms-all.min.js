...
if(typeof zmiParams['lang']=='undefined'){zmiParams['lang']=$('html').attr('lang')}
...
return langStr}
ZMI.prototype.getLangStr=function(key,lang){var k="get_lang_dict";var v=this.getCachedValue(k);if(typeof v=="undefined"){var url=this.getBaseUrl();v=$.ajax({url:url+'/get_lang_dict',contentType:'text/plain;charset=UTF-8',async:false
