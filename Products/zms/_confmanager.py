...
class ConfManager(
    ...
    def getConfPropertiesDefaults(self):
      return [
        ...
        {'key':'ZMS.input.exec.restrict','title':'ZMS.input.exec.restrict','desc':'Prevent usage of these keywords on standard.dt_exec and standard.get_env','datatype':'string','default':''},
