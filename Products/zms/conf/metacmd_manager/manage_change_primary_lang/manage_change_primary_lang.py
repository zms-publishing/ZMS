...
# ---------------------------------
	...
	print('<div class="form-group row">')
	print('<div class="col-sm-2 control-label">Swap content</div>')
	print('<div class="col-sm-10">')
	print('<input type="checkbox" class="form-check-input ml-0" id="swap_content" name="swap_content" value="1"/>')
	print('</div><!-- .col-sm-10 -->')
	print('</div><!-- .form-group -->')
	print('<div class="form-group row">')
