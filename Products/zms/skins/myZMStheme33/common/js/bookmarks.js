...
function initBookmarks() {
	...
	for (var i = 0; i < l.length; i++) {
		$("#add-bookmark").after(''
				...
				+ ' onmouseover="$(\'.glyphicon-times\',this).removeClass(\'text-muted\').addClass(\'text-danger\')"'
				+ ' onmouseout="$(\'.glyphicon-times\',this).removeClass(\'text-danger\').addClass(\'text-muted\')"'
				+ '><span class="glyphicon glyphicon-star text-primary"></span> '
				+ l[i].title + ' '
				+ '<span class="glyphicon glyphicon-times text-muted" title="Favorit entfernen"'
