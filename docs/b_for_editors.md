...
> **See also:**
> - [edit_intro_en.md](edit_intro_en.md) — original English editing guide
> - [edit_intro_de.md](edit_intro_de.md) — German version
> - [versioning.md](versioning.md) — detailed workflow and versioning reference
